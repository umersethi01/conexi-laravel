        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="reply-comment-block">
                    ...
                    <form action="inc/sendemail.php" class="contact-form-one row">
                        <div class="col-lg-6">
                    ...
                    <div class="single-sidebar latest-post-widget">
                        ...
                        <div class="post-wrapper">
                            <div class="single-latest-post">
                                <div class="image-block">
                                    <div class="inner-block">
                                        <img src="{{ asset('conexi/images/blog/lp-1-1.jpg') }}" alt="Awesome Image" />
                                    </div><!-- /.inner-block -->
                                </div><!-- /.image-block -->
                                <div class="text-block">
                            ...
                            <div class="single-latest-post">
                                <div class="image-block">
                                    <div class="inner-block">
                                        <img src="{{ asset('conexi/images/blog/lp-1-2.jpg') }}" alt="Awesome Image" />
                                    </div><!-- /.inner-block -->
                                </div><!-- /.image-block -->
                                <div class="text-block">
                            ...
                            <div class="single-latest-post">
                                <div class="image-block">
                                    <div class="inner-block">
                                        <img src="{{ asset('conexi/images/blog/lp-1-3.jpg') }}" alt="Awesome Image" />
                                    </div><!-- /.inner-block -->
                                </div><!-- /.image-block -->
                                <div class="text-block">
